...
print("Tuning Feedforward Neural Network Models")
...
with open("gridsearch_params/ffnn_adam.pkl", "wb") as handle:
...
with open("gridsearch_params/ffnn_ams.pkl", "wb") as handle:
    pickle.dump(ams_grid_result.best_params_, handle,  protocol = 3)

print("Done tuning FFNN ")